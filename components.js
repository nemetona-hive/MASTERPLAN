(() => {
  ...
  function LayoutVisualization({ result, hoveredType, setHoveredType, rowStart = "top", alwaysShowLabels = false, maxHeight = 420, onLargePreview }) {
    ...
    return /* @__PURE__ */ React2.createElement("div", { className: "viz-card" }, /* @__PURE__ */ React2.createElement("div", { style: { display: "flex", alignItems: "stretch", gap: "var(--sp-2)" } }, /* @__PURE__ */ React2.createElement("div", { style: { position: "relative", flex: 1, aspectRatio, maxHeight: `${maxHeight}px` } }, onLargePreview && /* @__PURE__ */ React2.createElement("button", { type: "button", className: "viz-expand-btn", onClick: () => onLargePreview(), title: alwaysShowLabels ? "Close large preview" : "Open large preview" }, /* @__PURE__ */ React2.createElement(Icon, { name: alwaysShowLabels ? "minimize" : "maximize" })), /* @__PURE__ */ React2.createElement(
      "svg",
      {
  ...
  function SheetSurfaceLayout({ sh, setSh, panelOpen, setPanelOpen }) {
    ...
    return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(Stack, { id: "data-control", className: "data-control", gap: 3 }, /* @__PURE__ */ React2.createElement(
    ...
    } }, /* @__PURE__ */ React2.createElement("div", { className: "mp-modal" }, /* @__PURE__ */ React2.createElement("div", { className: "mp-modal-head" }, /* @__PURE__ */ React2.createElement("span", null, "Manage Material Presets"), /* @__PURE__ */ React2.createElement("button", { className: "mp-modal-close", onClick: () => setShowModal(false) }, /* @__PURE__ */ React2.createElement(Icon, { name: "minus" }))), /* @__PURE__ */ React2.createElement("div", { className: "mp-modal-body" }, /* @__PURE__ */ React2.createElement(Stack, { gap: 4 }, /* @__PURE__ */ React2.createElement(Stack, { gap: 3 }, /* @__PURE__ */ React2.createElement("div", { className: "pw-preset-header", style: { gridTemplateColumns: "2.2fr 1fr 1fr 84px" } }, /* @__PURE__ */ React2.createElement("span", null, "Product Name"), /* @__PURE__ */ React2.createElement("span", null, "Width mm"), /* @__PURE__ */ React2.createElement("span", null, "Length mm"), /* @__PURE__ */ React2.createElement("span", null, " ")), presets.map((p, idx) => /* @__PURE__ */ React2.createElement("div", { key: idx, className: "pw-preset-row" + (activePreset === idx ? " pw-preset-active" : "") }, /* @__PURE__ */ React2.createElement("div", { className: "pw-preset-fields", style: { gridTemplateColumns: "2.2fr 1fr 1fr 84px" } }, /* @__PURE__ */ React2.createElement("div", null, /* @__PURE__ */ React2.createElement("span", { className: "pw-preset-lbl-hide" }, "Product Name"), /* @__PURE__ */ React2.createElement(
      "input",
      {
      ...
      } }, /* @__PURE__ */ React2.createElement("div", { className: "mp-modal mp-modal-large" }, /* @__PURE__ */ React2.createElement("div", { className: "mp-modal-head" }, /* @__PURE__ */ React2.createElement("span", null, "Large layout preview — ", largePreview.layout.title), /* @__PURE__ */ React2.createElement("button", { className: "mp-modal-close", onClick: closeLargePreview }, /* @__PURE__ */ React2.createElement(Icon, { name: "minus" }))), /* @__PURE__ */ React2.createElement("div", { className: "mp-modal-body" }, /* @__PURE__ */ React2.createElement(Stack, { gap: 4 }, currentResult.summaryRows.length > 0 && /* @__PURE__ */ React2.createElement("div", { className: "summary-grid" }, /* @__PURE__ */ React2.createElement(PanelSummary, { rows: currentResult.summaryRows, hoveredType, setHoveredType })), /* @__PURE__ */ React2.createElement("div", { className: "large-layout-vis-wrap data-preview", style: { background: "var(--color-bg-alt)", borderRadius: "var(--radius-lg)", border: "1px solid var(--color-border)" } }, /* @__PURE__ */ React2.createElement(LayoutVisualization, { result: currentResult, hoveredType, setHoveredType, rowStart, maxHeight: 1e3, alwaysShowLabels: true, onLargePreview: closeLargePreview })), /* @__PURE__ */ React2.createElement("div", { className: "large-preview-grid" }, /* @__PURE__ */ React2.createElement(Stack, { gap: 4, className: "u-hide-mobile" }, /* @__PURE__ */ React2.createElement(
